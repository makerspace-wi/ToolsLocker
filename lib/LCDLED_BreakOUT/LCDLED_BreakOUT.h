...
#ifndef LCDLED_BreakOUT_h
#define LCDLED_BreakOUT_h
...
#define BUTTON_P2 0x02
#define BUTTON_P1 0x01


class LCDLED_BreakOUT : public Print {
public:
  LCDLED_BreakOUT();
...
//  void sendLEDs(uint8_t, uint8_t);
  uint8_t readButtons();
  void pinLEDs(uint8_t, uint8_t);
